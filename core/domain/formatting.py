...
def kk_ago(days: int, hours: Optional[int] = None,
    ...
    минуты: у метки «взял в работу» (BR-82), которую ставят и снимают за
