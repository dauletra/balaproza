...
def search_index_json(request):
    ...
    Кэш **с ограниченным сроком**, а не на всю жизнь процесса: иначе
    принятый тег и опубликованная работа не попадают в индекс до
    перезапуска, причём у каждого воркера по-своему. Пять минут — та же
    граница, что у остальных справочников.
    """
