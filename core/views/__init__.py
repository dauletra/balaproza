...
Модули названы разделами продукта — теми же, которыми размечен
`core/urls.py`: конкурсы живут в `views/contests.py` и нигде больше. Имена собраны здесь поимённо — `core/urls.py` знает
