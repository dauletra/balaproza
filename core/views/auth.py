...
def telegram_callback(request):
 ...
 Уже заведённый аккаунт логинится сразу и уходит на `next`;
...
def onboarding(request):
    """Онбординг после первого входа. Завершённость —
    `terms_accepted_at`: повторный заход сюда уже онбордившегося
