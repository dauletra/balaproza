"""Справочники: 12 жанров и стартовый блок-лист тегов.

Миграцией, а не сидом: это не демо-контент, а часть системы — без жанров
портал не работает, и справочник обязан приезжать вместе со схемой.

Значения вписаны литералами: данные миграции заморожены на момент её
написания, а импорт живого модуля менял бы смысл уже применённой миграции
