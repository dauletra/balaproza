...
class Author:
    ...
    # возраст аккаунта (DEC-57), и 1 января превращало бы в новичка того,
...
AUTHORS = [
    Author("rudazov",   "Алмат Рысқали",     "Rudazov",       "Фэнтези, шытырман", 1050),
    Author("aygerim_k", "Айгерім Қасенова",  "aiqalam",       "Жас прозаик · Алматы", 430),
    Author("bekzhan_t", "Бекжан Тұрсынов",   "BekTor",        "Қалалық әңгімелер", 540),
    Author("dina_books","Дина Айдарбекова",  "dina.books",    "Балалар әдебиеті", 300),
    Author("sayyn",     "Сайын Нұрбекұлы",   "sayyn",         "Фантастика, шытырман", 620),
    # Демо-пользователь, под которым логинимся через фейк-сессию (см. core.views.login_view).
    Author("aidana",    "Айдана Серікқызы",  "aidana",        "Жас прозаик · Тараз", 160),
]
...
CHAPTERS_BY_STORY: dict = {
    ...
    # ревизия, а не статус (BR-79), и работы на проверке без единой главы
