...
сегодняшнего дня (DEC-45), и застывший JSON через месяц перевёл бы конкурс
...
class Command(BaseCommand):
    ...
    def _seed_tags(self):
        """UGC-теги. Счётчиков витрин здесь нет (DEC-53): оба считаются по
    ...
    def _seed_library(self):
        ...
        и только у них (DEC-52). Оставшееся время не литерал, а сумма глав
