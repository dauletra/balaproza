...
class PersonalPagesStayWithinTheirQueryBudget(TestCase):
    ...
    def test_manage_story(self):
        ...
        Разделение ревизий (BR-79) добавило к каждой выборке глав их
        ...
        модератора (BR-80): замечание висит на этой странице до
    ...
    def test_chapter_editor(self):
        ...
        Было 6 (сама глава, `chapter_by_id` — BR-83, — одним
