...
Впереди, помимо этапов аудита: Telegram Login Widget с проверкой подписи
(NFR-25 ⛔ — до него публичный запуск небезопасен), ось «Жаңа есімдер»
(`NEW_AUTHOR_FOLLOWERS` не отличает никого — нужно продуктовое решение).
