...
**Оптимизация кодовой базы закончена** — все десять шагов и их разбор в
[`PLAN-OPTIMIZATION.md`](PLAN-OPTIMIZATION.md). Правила ниже уже учитывают её
итог, отдельного приоритета у плана больше нет.
...
запуск небезопасен), автосохранение черновика по debounce, ось «Жаңа есімдер»
