...
Widget с проверкой подписи (NFR-25, BR-90): кнопка ведёт на Telegram, тот
...
вычищает строки, вышедшие из него (DEC-55). Без неё колонка только растёт:
...
подписи, демо-входа больше нет. Осталось только то, что делается один раз
